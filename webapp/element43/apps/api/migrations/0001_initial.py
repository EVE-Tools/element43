...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('api_apikey', (
            ...
            ('keyid', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('vcode', self.gf('django.db.models.fields.TextField')()),
            ('expires', self.gf('django.db.models.fields.DateTimeField')()),
            ('accessmask', self.gf('django.db.models.fields.BigIntegerField')()),
        ...
        # Adding model 'APITimer'
        db.create_table('api_apitimer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('character', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Character'])),
            ('apisheet', self.gf('django.db.models.fields.TextField')()),
            ('nextupdate', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('api', ['APITimer'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'APITimer'
        db.delete_table('api_apitimer')
