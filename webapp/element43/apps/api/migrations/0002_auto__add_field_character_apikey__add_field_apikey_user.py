...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.apikey'
        db.add_column('api_character', 'apikey',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['api.APIKey']),
                      keep_default=False)

        # Adding field 'APIKey.user'
        db.add_column('api_apikey', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.apikey'
        db.delete_column('api_character', 'apikey_id')

        # Deleting field 'APIKey.user'
        db.delete_column('api_apikey', 'user_id')
