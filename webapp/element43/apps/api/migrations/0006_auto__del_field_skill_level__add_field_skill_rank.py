...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('api_skill', 'level')

        # Adding field 'Skill.rank'
        db.add_column('api_skill', 'rank',
    ...
    def backwards(self, orm):
        ...
        db.add_column('api_skill', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Skill.rank'
        db.delete_column('api_skill', 'rank')
