...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('api_marketorder', (
            ('id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['market_data.Orders'], primary_key=True)),
            ('character', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Character'])),
            ('order_state', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('account_key', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('escrow', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('api', ['MarketOrder'])


    def backwards(self, orm):
        # Deleting model 'MarketOrder'
        db.delete_table('api_marketorder')
    ...
    models = {
        ...
        'api.character': {
            ...
            'cached_until': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 16, 0, 0)'}),
            ...
            'dob': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 16, 0, 0)'}),
