...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Corp'
        db.create_table('api_corp', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('corp_id', self.gf('django.db.models.fields.BigIntegerField')(db_index=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
            ('ticker', self.gf('django.db.models.fields.TextField')()),
            ('ceo_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('ceo_name', self.gf('django.db.models.fields.TextField')()),
            ('stastation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.StaStation'])),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('url', self.gf('django.db.models.fields.TextField')()),
            ('tax_rate', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('member_count', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ...
        db.send_create_signal('api', ['Corp'])

        # Adding model 'CorpDivision'
        db.create_table('api_corpdivision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('corporation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Corp'])),
            ('account_key', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('api', ['CorpDivision'])

        # Adding model 'CorpWalletDivision'
        db.create_table('api_corpwalletdivision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('corporation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Corp'])),
            ('account_key', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('api', ['CorpWalletDivision'])

        # Adding field 'APITimer.corporation'
        db.add_column('api_apitimer', 'corporation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['api.Corp'], null=True),
                      keep_default=False)


        # Changing field 'APITimer.character'
        db.alter_column('api_apitimer', 'character_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Character'], null=True))
        # Adding field 'APIKey.is_character_key'
        db.add_column('api_apikey', 'is_character_key',
    ...
    def backwards(self, orm):
        # Deleting model 'Corp'
        db.delete_table('api_corp')

        # Deleting model 'CorpDivision'
        db.delete_table('api_corpdivision')

        # Deleting model 'CorpWalletDivision'
        db.delete_table('api_corpwalletdivision')

        # Deleting field 'APITimer.corporation'
        db.delete_column('api_apitimer', 'corporation_id')


        # Changing field 'APITimer.character'
        db.alter_column('api_apitimer', 'character_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['api.Character']))
        # Deleting field 'APIKey.is_character_key'
        db.delete_column('api_apikey', 'is_character_key')
    ...
    models = {
        ...
        'api.character': {
            ...
            'cached_until': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 17, 0, 0)'}),
            ...
            'dob': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 17, 0, 0)'}),
