...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('api_journalentry', (
            ...
            ('is_coporate_transaction', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('ref_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.RefType'])),
            ('amount', self.gf('django.db.models.fields.FloatField')()),
            ('balance', self.gf('django.db.models.fields.FloatField')()),
            ('owner_name_1', self.gf('django.db.models.fields.TextField')()),
            ('owner_id_1', self.gf('django.db.models.fields.BigIntegerField')()),
            ('owner_name_2', self.gf('django.db.models.fields.TextField')()),
            ('owner_id_2', self.gf('django.db.models.fields.BigIntegerField')()),
            ('arg_name_1', self.gf('django.db.models.fields.TextField')()),
            ('arg_id_1', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('reason', self.gf('django.db.models.fields.TextField')()),
            ('tax_receiver_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('tax_amount', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('api', ['JournalEntry'])


    def backwards(self, orm):
        # Deleting model 'JournalEntry'
        db.delete_table('api_journalentry')
