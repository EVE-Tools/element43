...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarketOrder.corporation'
        db.add_column('api_marketorder', 'corporation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['api.Corp'], null=True),
                      keep_default=False)


        # Changing field 'MarketOrder.character'
        db.alter_column('api_marketorder', 'character_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Character'], null=True))
        # Deleting field 'JournalEntry.is_corporate_transaction'
        db.delete_column('api_journalentry', 'is_corporate_transaction')

        # Adding field 'JournalEntry.corporation'
        db.add_column('api_journalentry', 'corporation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['api.Corp'], null=True),
                      keep_default=False)


        # Changing field 'JournalEntry.character'
        db.alter_column('api_journalentry', 'character_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Character'], null=True))
        # Adding field 'MarketTransaction.corporation'
        db.add_column('api_markettransaction', 'corporation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['api.Corp'], null=True),
                      keep_default=False)


        # Changing field 'MarketTransaction.character'
        db.alter_column('api_markettransaction', 'character_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Character'], null=True))

    def backwards(self, orm):
        # Deleting field 'MarketOrder.corporation'
        db.delete_column('api_marketorder', 'corporation_id')


        # Changing field 'MarketOrder.character'
        db.alter_column('api_marketorder', 'character_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['api.Character']))
        # Adding field 'JournalEntry.is_corporate_transaction'
        db.add_column('api_journalentry', 'is_corporate_transaction',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'JournalEntry.corporation'
        db.delete_column('api_journalentry', 'corporation_id')


        # Changing field 'JournalEntry.character'
        db.alter_column('api_journalentry', 'character_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['api.Character']))
        # Deleting field 'MarketTransaction.corporation'
        db.delete_column('api_markettransaction', 'corporation_id')


        # Changing field 'MarketTransaction.character'
        db.alter_column('api_markettransaction', 'character_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['api.Character']))
    ...
    models = {
        ...
        'api.character': {
            ...
            'cached_until': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 23, 0, 0)'}),
            ...
            'dob': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 23, 0, 0)'}),
