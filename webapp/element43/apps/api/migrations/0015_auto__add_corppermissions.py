...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CorpPermissions'
        db.create_table('api_corppermissions', (
            ...
            ('view_wallet', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('view_transaction', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('view_research', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('modify_rights', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('api', ['CorpPermissions'])


    def backwards(self, orm):
        # Deleting model 'CorpPermissions'
        db.delete_table('api_corppermissions')
    ...
    models = {
        ...
        'api.character': {
            ...
            'cached_until': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 12, 0, 0)'}),
            ...
            'dob': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 12, 0, 0)'}),
        ...
        'api.corppermissions': {
            'Meta': {'object_name': 'CorpPermissions'},
            'character': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['api.Character']"}),
            'corporation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['api.Corp']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modify_rights': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'view_research': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'view_transaction': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'view_wallet': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
