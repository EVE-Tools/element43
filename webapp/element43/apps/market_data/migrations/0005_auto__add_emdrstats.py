...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmdrStats'
        db.create_table('market_data_emdrstats', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status_type', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('status_count', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('message_timestamp', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('market_data', ['EmdrStats'])


    def backwards(self, orm):
        # Deleting model 'EmdrStats'
        db.delete_table('market_data_emdrstats')
