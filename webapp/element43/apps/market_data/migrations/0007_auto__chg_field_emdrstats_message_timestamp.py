...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmdrStats.message_timestamp'
        db.alter_column('market_data_emdrstats', 'message_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'EmdrStats.message_timestamp'
        db.alter_column('market_data_emdrstats', 'message_timestamp', self.gf('django.db.models.fields.DateTimeField')())
