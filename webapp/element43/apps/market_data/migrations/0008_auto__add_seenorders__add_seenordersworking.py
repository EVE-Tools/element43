...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SeenOrders'
        db.create_table('market_data_seenorders', (
        ...
        db.send_create_signal('market_data', ['SeenOrders'])
    ...
    def backwards(self, orm):
        # Deleting model 'SeenOrders'
        db.delete_table('market_data_seenorders')
    ...
    models = {
        ...
        'market_data.seenordersworking': {
            'Meta': {'object_name': 'SeenOrdersWorking'},
            'id': ('django.db.models.fields.BigIntegerField', [], {'primary_key': 'True'}),
            'region_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'type_id': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
