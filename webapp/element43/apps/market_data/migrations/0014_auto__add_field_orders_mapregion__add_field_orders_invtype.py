...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Orders.mapregion'
        db.add_column('market_data_orders', 'mapregion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.MapRegion'], null=True),
                      keep_default=False)

        # Adding field 'Orders.invtype'
        db.add_column('market_data_orders', 'invtype',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.InvType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Orders.mapregion'
        db.delete_column('market_data_orders', 'mapregion_id')

        # Deleting field 'Orders.invtype'
        db.delete_column('market_data_orders', 'invtype_id')
    ...
    models = {
        ...
        'market_data.orders': {
            ...
            'invtype': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eve_db.InvType']", 'null': 'True'}),
            ...
            'mapregion': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eve_db.MapRegion']", 'null': 'True'}),
