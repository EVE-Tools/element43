...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrdersWarehouse.mapregion'
        db.add_column('market_data_orderswarehouse', 'mapregion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=10000002, to=orm['eve_db.MapRegion']),
                      keep_default=False)

        # Adding field 'OrdersWarehouse.invtype'
        db.add_column('market_data_orderswarehouse', 'invtype',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=34, to=orm['eve_db.InvType']),
                      keep_default=False)

        # Adding field 'OrdersWarehouse.stastation'
        db.add_column('market_data_orderswarehouse', 'stastation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=60000238, to=orm['eve_db.StaStation']),
                      keep_default=False)

        # Adding field 'OrdersWarehouse.mapsolarsystem'
        db.add_column('market_data_orderswarehouse', 'mapsolarsystem',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=30004102, to=orm['eve_db.MapSolarSystem']),
                      keep_default=False)

        # Adding field 'History.mapregion'
        db.add_column('market_data_history', 'mapregion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=10000002, to=orm['eve_db.MapRegion']),
                      keep_default=False)

        # Adding field 'History.invtype'
        db.add_column('market_data_history', 'invtype',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=34, to=orm['eve_db.InvType']),
                      keep_default=False)

        # Adding field 'Orders.stastation'
        db.add_column('market_data_orders', 'stastation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=60000238, to=orm['eve_db.StaStation']),
                      keep_default=False)

        # Adding field 'Orders.mapsolarsystem'
        db.add_column('market_data_orders', 'mapsolarsystem',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=30004102, to=orm['eve_db.MapSolarSystem']),
                      keep_default=False)


        # Changing field 'Orders.invtype'
        db.alter_column('market_data_orders', 'invtype_id', self.gf('django.db.models.fields.related.ForeignKey')(default=34, to=orm['eve_db.InvType']))

        # Changing field 'Orders.mapregion'
        db.alter_column('market_data_orders', 'mapregion_id', self.gf('django.db.models.fields.related.ForeignKey')(default=10000002, to=orm['eve_db.MapRegion']))

    def backwards(self, orm):
        # Deleting field 'OrdersWarehouse.mapregion'
        db.delete_column('market_data_orderswarehouse', 'mapregion_id')

        # Deleting field 'OrdersWarehouse.invtype'
        db.delete_column('market_data_orderswarehouse', 'invtype_id')

        # Deleting field 'OrdersWarehouse.stastation'
        db.delete_column('market_data_orderswarehouse', 'stastation_id')

        # Deleting field 'OrdersWarehouse.mapsolarsystem'
        db.delete_column('market_data_orderswarehouse', 'mapsolarsystem_id')

        # Deleting field 'History.mapregion'
        db.delete_column('market_data_history', 'mapregion_id')

        # Deleting field 'History.invtype'
        db.delete_column('market_data_history', 'invtype_id')

        # Deleting field 'Orders.stastation'
        db.delete_column('market_data_orders', 'stastation_id')

        # Deleting field 'Orders.mapsolarsystem'
        db.delete_column('market_data_orders', 'mapsolarsystem_id')


        # Changing field 'Orders.invtype'
        db.alter_column('market_data_orders', 'invtype_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.InvType'], null=True))

        # Changing field 'Orders.mapregion'
        db.alter_column('market_data_orders', 'mapregion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.MapRegion'], null=True))
