...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OrdersWarehouse.solar_system_id'
        db.delete_column('market_data_orderswarehouse', 'solar_system_id')

        # Deleting field 'OrdersWarehouse.type_id'
        db.delete_column('market_data_orderswarehouse', 'type_id')

        # Deleting field 'OrdersWarehouse.station_id'
        db.delete_column('market_data_orderswarehouse', 'station_id')

        # Deleting field 'OrdersWarehouse.region_id'
        db.delete_column('market_data_orderswarehouse', 'region_id')

        # Adding index on 'OrdersWarehouse', fields ['uploader_ip_hash']
        db.create_index('market_data_orderswarehouse', ['uploader_ip_hash'])

        # Deleting field 'History.type_id'
        db.delete_column('market_data_history', 'type_id')

        # Deleting field 'History.region_id'
        db.delete_column('market_data_history', 'region_id')

        # Deleting field 'Orders.region_id'
        db.delete_column('market_data_orders', 'region_id')

        # Deleting field 'Orders.solar_system_id'
        db.delete_column('market_data_orders', 'solar_system_id')

        # Deleting field 'Orders.type_id'
        db.delete_column('market_data_orders', 'type_id')

        # Deleting field 'Orders.station_id'
        db.delete_column('market_data_orders', 'station_id')

        # Adding index on 'Orders', fields ['uploader_ip_hash']
        db.create_index('market_data_orders', ['uploader_ip_hash'])


    def backwards(self, orm):
        # Removing index on 'Orders', fields ['uploader_ip_hash']
        db.delete_index('market_data_orders', ['uploader_ip_hash'])

        # Removing index on 'OrdersWarehouse', fields ['uploader_ip_hash']
        db.delete_index('market_data_orderswarehouse', ['uploader_ip_hash'])

        # Adding field 'OrdersWarehouse.solar_system_id'
        db.add_column('market_data_orderswarehouse', 'solar_system_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=30000109),
                      keep_default=False)

        # Adding field 'OrdersWarehouse.type_id'
        db.add_column('market_data_orderswarehouse', 'type_id',
                      self.gf('django.db.models.fields.BigIntegerField')(default=34, db_index=True),
                      keep_default=False)

        # Adding field 'OrdersWarehouse.station_id'
        db.add_column('market_data_orderswarehouse', 'station_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=60012550),
                      keep_default=False)

        # Adding field 'OrdersWarehouse.region_id'
        db.add_column('market_data_orderswarehouse', 'region_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=10000002),
                      keep_default=False)

        # Adding field 'History.type_id'
        db.add_column('market_data_history', 'type_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=34, db_index=True),
                      keep_default=False)

        # Adding field 'History.region_id'
        db.add_column('market_data_history', 'region_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=10000002, db_index=True),
                      keep_default=False)

        # Adding field 'Orders.region_id'
        db.add_column('market_data_orders', 'region_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=10000002),
                      keep_default=False)

        # Adding field 'Orders.solar_system_id'
        db.add_column('market_data_orders', 'solar_system_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=60012550),
                      keep_default=False)

        # Adding field 'Orders.type_id'
        db.add_column('market_data_orders', 'type_id',
                      self.gf('django.db.models.fields.BigIntegerField')(default=34, db_index=True),
                      keep_default=False)

        # Adding field 'Orders.station_id'
        db.add_column('market_data_orders', 'station_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=60012550),
                      keep_default=False)
