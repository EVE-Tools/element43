...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('market_data_profile', (
            ...
            ('api_valid', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('api_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('api_verification_code', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('market_data', ['Profile'])


    def backwards(self, orm):
        # Deleting model 'Profile'
        db.delete_table('market_data_profile')
    ...
    models = {
        ...
        'market_data.profile': {
            ...
            'api_verification_code': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
