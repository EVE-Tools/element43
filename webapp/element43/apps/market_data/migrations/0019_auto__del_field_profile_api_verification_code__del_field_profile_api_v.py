...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.api_verification_code'
        db.delete_column('market_data_profile', 'api_verification_code')

        # Deleting field 'Profile.api_valid'
        db.delete_column('market_data_profile', 'api_valid')

        # Deleting field 'Profile.api_id'
        db.delete_column('market_data_profile', 'api_id')


    def backwards(self, orm):
        # Adding field 'Profile.api_verification_code'
        db.add_column('market_data_profile', 'api_verification_code',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=255),
                      keep_default=False)

        # Adding field 'Profile.api_valid'
        db.add_column('market_data_profile', 'api_valid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Profile.api_id'
        db.add_column('market_data_profile', 'api_id',
