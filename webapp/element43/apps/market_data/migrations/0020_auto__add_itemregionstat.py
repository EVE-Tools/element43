...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ItemRegionStat'
        db.create_table('market_data_itemregionstat', (
        ...
        db.send_create_signal('market_data', ['ItemRegionStat'])


    def backwards(self, orm):
        # Deleting model 'ItemRegionStat'
        db.delete_table('market_data_itemregionstat')
