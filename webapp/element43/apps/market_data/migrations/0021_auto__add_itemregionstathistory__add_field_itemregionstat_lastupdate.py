...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ItemRegionStatHistory'
        db.create_table('market_data_itemregionstathistory', (
            ...
            ('buymean', self.gf('django.db.models.fields.FloatField')()),
            ('buyavg', self.gf('django.db.models.fields.FloatField')()),
            ('sellmean', self.gf('django.db.models.fields.FloatField')()),
            ('sellavg', self.gf('django.db.models.fields.FloatField')()),
            ('buymedian', self.gf('django.db.models.fields.FloatField')()),
            ('sellmedian', self.gf('django.db.models.fields.FloatField')()),
            ('date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('market_data', ['ItemRegionStatHistory'])

        # Adding field 'ItemRegionStat.lastupdate'
        db.add_column('market_data_itemregionstat', 'lastupdate',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ItemRegionStatHistory'
        db.delete_table('market_data_itemregionstathistory')

        # Deleting field 'ItemRegionStat.lastupdate'
        db.delete_column('market_data_itemregionstat', 'lastupdate')
