...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('market_data_orderhistory', (
            ...
            ('numorders', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('low', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('high', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('mean', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('quantity', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('market_data', ['OrderHistory'])


    def backwards(self, orm):
        # Deleting model 'OrderHistory'
        db.delete_table('market_data_orderhistory')
    ...
    models = {
        ...
        'market_data.orderhistory': {
            ...
            'high': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invtype': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eve_db.InvType']"}),
            'low': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'mapregion': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eve_db.MapRegion']"}),
            'mean': ('django.db.models.fields.PositiveIntegerField', [], {}),
