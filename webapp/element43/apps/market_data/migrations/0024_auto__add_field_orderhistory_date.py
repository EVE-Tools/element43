...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderHistory.date'
        db.add_column('market_data_orderhistory', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 10, 5, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderHistory.date'
        db.delete_column('market_data_orderhistory', 'date')
