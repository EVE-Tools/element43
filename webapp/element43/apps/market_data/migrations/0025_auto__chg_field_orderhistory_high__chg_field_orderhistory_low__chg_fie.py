...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderHistory.high'
        db.alter_column('market_data_orderhistory', 'high', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'OrderHistory.low'
        db.alter_column('market_data_orderhistory', 'low', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'OrderHistory.mean'
        db.alter_column('market_data_orderhistory', 'mean', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'OrderHistory.quantity'
        db.alter_column('market_data_orderhistory', 'quantity', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'OrderHistory.high'
        db.alter_column('market_data_orderhistory', 'high', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'OrderHistory.low'
        db.alter_column('market_data_orderhistory', 'low', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'OrderHistory.mean'
        db.alter_column('market_data_orderhistory', 'mean', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'OrderHistory.quantity'
        db.alter_column('market_data_orderhistory', 'quantity', self.gf('django.db.models.fields.PositiveIntegerField')())
