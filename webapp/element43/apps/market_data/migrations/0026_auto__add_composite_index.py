...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderHistory.id'
        db.create_unique('market_data_orderhistory', ['mapregion_id', 'invtype_id', 'date'])

    def backwards(self, orm):

        # Changing field 'OrderHistory.id'
        db.delete_unique('market_data_orderhistory', ['mapregion_id', 'invtype_id', 'date'])
