...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemRegionStatHistory.buyvolume'
        db.add_column('market_data_itemregionstathistory', 'buyvolume',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ItemRegionStatHistory.sellvolume'
        db.add_column('market_data_itemregionstathistory', 'sellvolume',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ItemRegionStatHistory.buy_95_percentile'
        db.add_column('market_data_itemregionstathistory', 'buy_95_percentile',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'ItemRegionStatHistory.sell_95_percentile'
        db.add_column('market_data_itemregionstathistory', 'sell_95_percentile',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


        # Adding field 'ItemRegionStat.buyvolume'
        db.add_column('market_data_itemregionstat', 'buyvolume',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ItemRegionStat.sellvolume'
        db.add_column('market_data_itemregionstat', 'sellvolume',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ItemRegionStat.buy_95_percentile'
        db.add_column('market_data_itemregionstat', 'buy_95_percentile',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'ItemRegionStat.sell_95_percentile'
        db.add_column('market_data_itemregionstat', 'sell_95_percentile',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemRegionStatHistory.buyvolume'
        db.delete_column('market_data_itemregionstathistory', 'buyvolume')

        # Deleting field 'ItemRegionStatHistory.sellvolume'
        db.delete_column('market_data_itemregionstathistory', 'sellvolume')

        # Deleting field 'ItemRegionStatHistory.buy_95_percentile'
        db.delete_column('market_data_itemregionstathistory', 'buy_95_percentile')

        # Deleting field 'ItemRegionStatHistory.sell_95_percentile'
        db.delete_column('market_data_itemregionstathistory', 'sell_95_percentile')


        # Deleting field 'ItemRegionStat.buyvolume'
        db.delete_column('market_data_itemregionstat', 'buyvolume')

        # Deleting field 'ItemRegionStat.sellvolume'
        db.delete_column('market_data_itemregionstat', 'sellvolume')

        # Deleting field 'ItemRegionStat.buy_95_percentile'
        db.delete_column('market_data_itemregionstat', 'buy_95_percentile')

        # Deleting field 'ItemRegionStat.sell_95_percentile'
        db.delete_column('market_data_itemregionstat', 'sell_95_percentile')
