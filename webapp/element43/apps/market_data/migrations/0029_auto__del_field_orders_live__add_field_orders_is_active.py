...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Orders.live'
        db.delete_column('market_data_orders', 'live')

        # Adding field 'Orders.is_active'
        db.add_column('market_data_orders', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Orders.live'
        db.add_column('market_data_orders', 'live',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Orders.is_active'
        db.delete_column('market_data_orders', 'is_active')
