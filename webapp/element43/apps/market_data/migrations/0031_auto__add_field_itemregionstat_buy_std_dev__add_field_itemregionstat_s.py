...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemRegionStat.buy_std_dev'
        db.add_column('market_data_itemregionstat', 'buy_std_dev',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'ItemRegionStat.sell_std_dev'
        db.add_column('market_data_itemregionstat', 'sell_std_dev',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemRegionStat.buy_std_dev'
        db.delete_column('market_data_itemregionstat', 'buy_std_dev')

        # Deleting field 'ItemRegionStat.sell_std_dev'
        db.delete_column('market_data_itemregionstat', 'sell_std_dev')
