...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArchivedOrders'
        db.create_table(u'market_data_archivedorders', (
        ...
        db.send_create_signal(u'market_data', ['ArchivedOrders'])


    def backwards(self, orm):
        # Deleting model 'ArchivedOrders'
        db.delete_table(u'market_data_archivedorders')
