...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArchivedOrders.message_key'
        db.alter_column(u'market_data_archivedorders', 'message_key', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Orders.message_key'
        db.alter_column(u'market_data_orders', 'message_key', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'ArchivedOrders.message_key'
        db.alter_column(u'market_data_archivedorders', 'message_key', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Orders.message_key'
        db.alter_column(u'market_data_orders', 'message_key', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    ...
    models = {
        ...
        u'market_data.archivedorders': {
            'Meta': {'object_name': 'ArchivedOrders'},
            ...
            'message_key': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        u'market_data.emdrstatsworking': {
            'Meta': {'object_name': 'EmdrStatsWorking'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status_type': ('django.db.models.fields.SmallIntegerField', [], {})
        },
        u'market_data.history': {
        ...
        u'market_data.itemregionstathistory': {
